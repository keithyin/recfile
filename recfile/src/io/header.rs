...
const RFF_HEADER_MAGIC_NUMBER: &'static str = "SEQUENTIAL_RFF_HEADER_V001";
#[derive(Debug, bincode::Encode, bincode::Decode)]
pub struct SequentialRffHeader {
    magic_number: String,
    buf_size: usize,
    num_records: usize,
}

impl SequentialRffHeader {
...
const INDEXED_RFF_HEADER_V1_MAGIC_NUMBER: &'static str = "INDEXED_RFF_V001";
...
impl IndexedRffReaderHeader {
    pub fn new(buf_size: usize) -> Self {
        Self {
            magic_number: INDEXED_RFF_HEADER_V1_MAGIC_NUMBER.to_string(),
            buf_size,
        }
    }

    pub fn check_valid(&self) {
        assert!(self.magic_number.eq(INDEXED_RFF_HEADER_V1_MAGIC_NUMBER));
    }
    pub fn buf_size(&self) -> usize {
        self.buf_size
    }
...
const INDEXED_RFF_HEADER_V2_MAGIC_NUMBER: &'static str = "INDEXED_RFF_V002";

#[derive(Debug, bincode::Decode, bincode::Encode)]
pub struct IndexedRffHeaderV2 {
    magic_number: String,
    buf_size: usize,
}
impl IndexedRffHeaderV2 {
    pub fn new(buf_size: usize) -> Self {
        Self {
